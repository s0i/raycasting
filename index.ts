    ...
    window.addEventListener("keydown", (e) => {
        if (!e.repeat) {
            switch (e.code) {
                ...
                case 'AltLeft': case 'AltRight': player.altKey   = true; break;
                case 'ShiftLeft': case 'ShiftRight': player.shiftKey  = true; break;
            }
        }
    });
    window.addEventListener("keyup", (e) => {
        if (!e.repeat) {
            switch (e.code) {
                ...
                case 'AltLeft': case 'AltRight': player.altKey   = false; break;
                case 'ShiftLeft': case 'ShiftRight': player.shiftKey  = false; break;
            }
        }
    });
